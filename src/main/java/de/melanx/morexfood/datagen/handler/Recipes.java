...
public class Recipes extends RecipeProvider {
    ...
    private ShapelessRecipeBuilder registerShapelessRecipe(Item result, List<ITag.INamedTag<Item>> tagIngredients, List<Item> ingredients) {
        ShapelessRecipeBuilder builder = ShapelessRecipeBuilder.shapelessRecipe(result);
        if (tagIngredients != null)
            for (ITag.INamedTag<Item> tag : tagIngredients) {
