...
public class Registry {
    ...
    private static final Block.Properties blockProps = Block.Properties.of(Material.PLANT).noCollission().randomTicks().strength(0).sound(SoundType.CROP);
    ...
    private static final Item.Properties itemProps = new Item.Properties().tab(MoreXFood.creativeTab);
    ...
    public static final RegistryObject<Item> carrot_pieces = FOOD.register("carrot_pieces", () -> new Item(itemProps.food(buildFoodValues(1, 0.6F, new MobEffectInstance(MobEffects.POISON, 150, 1), 30))));
    ...
    public static final RegistryObject<Item> chicken_fricassee_raw = FOOD.register("chicken_fricassee_raw", () -> new Item(itemProps.food(buildFoodValues(4, 0.05F, new MobEffectInstance(MobEffects.POISON, 150, 1), 95))));
    ...
    public static final RegistryObject<Item> chicken_fricassee_special_raw = FOOD.register("chicken_fricassee_special_raw", () -> new Item(itemProps.food(buildFoodValues(4, 0.05F, new MobEffectInstance(MobEffects.POISON, 120, 1), 95))));
    ...
    public static final RegistryObject<Item> chicken_fricassee_rice_raw = FOOD.register("chicken_fricassee_rice_raw", () -> new Item(itemProps.food(buildFoodValues(5, 0.05F, new MobEffectInstance(MobEffects.POISON, 100, 1), 90))));
    ...
    public static final RegistryObject<Item> dog_goulash = FOOD.register("dog_goulash", () -> new Item(itemProps.food(buildFoodValues(8, 0.45F, new MobEffectInstance(MobEffects.DAMAGE_BOOST, 150, 1), 30))));
    public static final RegistryObject<Item> dog_goulash_raw = FOOD.register("dog_meat_raw", () -> new Item(itemProps.food(buildFoodValues(4, 0.2F, new MobEffectInstance(MobEffects.POISON, 150, 1), 30))));
    public static final RegistryObject<Item> horse_meat = FOOD.register("horse_meat", () -> new Item(itemProps.food(buildFoodValues(4, 0.2F, new MobEffectInstance(MobEffects.POISON, 150, 1), 10))));
    public static final RegistryObject<Item> ice_cream = FOOD.register("ice_cream", () -> new Item(itemProps.food(buildFoodValues(5, 0.1F, new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 100, 1), 30))));
    public static final RegistryObject<Item> ice_cream_baked = FOOD.register("ice_cream_baked", () -> new Item(itemProps.food(buildFoodValues(2, 0.1F, new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 150, 1), 40))));
